...
This project doubles as a **structured curriculum for LangChain + LangGraph**.

Each day's work maps to specific concepts:

| Day | Concepts | Deliverable |
|---|---|---|
| 1 | Prompts, LCEL, output parsers | Synthetic dataset + first chain |
| 2 | Tools, ReAct, structured output | News Scanner Agent |
| 3 | LangGraph, state machines, parallelism | 5-agent orchestrator |
| 4 | Embeddings, vector stores, RAG | ChromaDB knowledge base |
| 5 | Streaming, callbacks, human-in-loop | Streamlit dashboard |
| 6 | Tracing, deployment, observability | Docker + cloud deploy |
| 7 | Evals, regression testing, polish | Eval harness + demo video |
