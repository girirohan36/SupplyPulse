...
📚 Open [`LEARNING_PATH.md`](LEARNING_PATH.md) for the structured curriculum.

📋 Build Checklist:
- [x] Foundations — DONE (you have this scaffold!)
- [ ] Polish News Agent + add tests
- [ ] Build Geo Risk + Finance Health agents (replace TODOs in `orchestrator/graph.py`)
- [ ] Add ChromaDB RAG over `historical_events.json`
- [ ] Streamlit dashboard with world map
- [ ] Dockerize + deploy to Render
- [ ] Eval harness + demo video + README polish
